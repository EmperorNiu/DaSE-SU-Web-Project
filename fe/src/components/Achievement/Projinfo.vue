  ...
  <div>
    <div class="proj-info-container">
      <div class="info">
        ...
        <div class="title">项目名称:{{projinfo.proj_name}}</div>
        <br /><br />
        <div class="author">项目负责人:{{projinfo.leader}}</div>
        <br /><br />
        <div class="members">项目其他成员:{{projinfo.members}}</div>
        <br /><br />
      </div>
      ...
      <button onclick="Apply(userid, projid)">申请</button>
      <button onclick="Download(userid, projid)">下载</button>
